...
public class AlienAnimations {
    ...
    public static final Animation ALIEN_ANIM_WALK = Animation.Builder.create(1.0F).looping()
    ...
    public static final Animation ALIEN_ANIM_ANGRY = Animation.Builder.create(0.25F)
            .addBoneAnimation("l_arm", new Transformation(Transformation.Targets.ROTATE,
			new Keyframe(0.0F, AnimationHelper.createRotationalVector(0.0F, 0.0F, 0.0F), Transformation.Interpolations.LINEAR),
